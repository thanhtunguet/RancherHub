...
This repository includes comprehensive GitHub Actions workflows for building and deploying Docker images for both the backend (NestJS) and frontend (Vite React) applications.
