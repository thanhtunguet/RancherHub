...
export class MessageTemplatesController {
  ...
  @ApiParam({ name: 'type', description: 'Template type', enum: ['test_connection', 'daily_health_check', 'critical_alert'] })
  @ApiResponse({ status: 200, description: 'Message template retrieved successfully' })
  ...
  @ApiParam({ name: 'id', description: 'Template ID' })
  @ApiResponse({ status: 200, description: 'Template restored to default successfully' })
